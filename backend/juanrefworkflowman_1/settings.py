"""
Django settings for juanrefworkflowman_1 project.
...
ROOT_URLCONF = 'juanrefworkflowman_1.urls'
...
WSGI_APPLICATION = 'juanrefworkflowman_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "juanrefworkflowman_1 API",
    "DESCRIPTION": "API documentation for juanrefworkflowman_1 App",
    "VERSION": "v1",
}
