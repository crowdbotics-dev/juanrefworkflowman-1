...
## Project Structure
    ...
    ├── juanrefworkflowman_1  # Django project configurations
...
1. Clone this repo and `cd juanrefworkflowman_1`
...
2. Clone this repo and `cd juanrefworkflowman_1`
